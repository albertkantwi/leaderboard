...
This is a simple game scores website that shows score of games pleyed. It has 'header section' where you can navigate through the menu.
A 'scores section' where it displays scores of games played and 'submit section' where you can add more scores.
...
```sh
  ...
  git clone git@github.com:albertkantwi/leaderboard.git
  cd leaderboard
...
Feel free to check the [Isuues Pages](https://https://github.com/albertkantwi/leaderboard/issues)
...
This project is [MIT](https://github.com/albertkantwi/leaderboard/blob/main/LICENSE) licensed.
